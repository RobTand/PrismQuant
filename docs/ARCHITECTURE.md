...
the serving pin JSON and its module constants all name `3efd690…` /
...
(`3efd690`, the merge of Tessera #324) rather than `b8b1cb38`, the commit that
...
`34f1da79…2a2c3e` (Tessera master `3efd690…`, contract v21; the release
...
document is stamped for (`3efd690`, contract v21) the packaged table is
...
Tessera `3efd690dd4e4a1b71fb604a14bee521dc57badb3` (master's tip at review
time, the merge of Tessera #324; version `0.1.0`, contract v21, lane schema
v8 — v21 landed eleven PR merges earlier in Tessera #313, `b8b1cb38`, and the
release `e78959ed…` carried v20; first pinned 2026-09-04 at `5acc2a6f…`,
contract v17)
