...
As of: 2026-08-24 · `codex/rtx4090-fp8-gridbook-pilot-20260824` · working-tree revision
based on `5cfa928` — stamps follow, newest first, each recording its own branch and date.
Re-stamped (2026-08-24, `codex/rtx4090-fp8-gridbook-pilot-20260824`) for the
