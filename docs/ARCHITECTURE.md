...
As of: 2026-09-03 · `pq-tessera-lane`. Stamps
...
`unrecorded` bucket is tested again. Previously stamped (2026-09-02,
`tessera/decouple-gridbook` — the integration branch,
carrying `tessera/remove-gridbook` and `tessera/continuous-menu`).
