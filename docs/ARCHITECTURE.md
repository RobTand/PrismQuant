...
As of: 2026-08-29 · `merge/proven-rescues` — stamps follow, newest first, each
recording its own branch and date. Re-stamped (2026-08-29,
`merge/proven-rescues`) for the **merge of `origin/main` (`1ca4c7d`) into this
branch**, which carries no new mechanism of its own. Two closure files are
merge products of two separately reviewed deltas — `model_profiles/base.py`
...
Previously re-stamped (2026-08-23, `merge/proven-rescues`) for
