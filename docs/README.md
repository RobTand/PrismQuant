...
| Path | What it is | Status |
|---|---|---|
| `audits/strix_halo_hip_live_audit_2026-07-31.md` | Live `gfx1151` source/correctness/performance audit of Gridbook's HIP kernels, including the production blockers, exact-runtime policy mismatches, W4A16 integration decision and INT8/INT4 promotion gates. | CURRENT OPEN AUDIT — dense arithmetic is credible; vLLM serving and production qualification remain open |
| `audits/architecture_re-vet_2026-07-30.md` | Five-lens architecture re-vet with dated rulings and implementation addenda; R7 owns the Strix serving-only decision and links the later live HIP audit. | HISTORICAL DECISION RECORD — read dated addenda for current disposition |
