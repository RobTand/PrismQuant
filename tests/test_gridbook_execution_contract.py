"""Capability-scoped v10 Gridbook execution-cell consumption."""
...
def test_only_device_qualified_routes_cover_exact_sm89_and_every_regime():
    contract = _qualify(_v10_contract())
...
def test_absent_or_fallback_regime_is_not_producer_legal():
    ...
    fallback = _qualify(_v10_contract())
...
def test_contract_version_must_move_with_v10_schema():
    contract = _v10_contract()
